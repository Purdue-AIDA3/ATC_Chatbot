...
def main(test_mode=False):
    ...
    # login to huggngface to access model Qwen tokenizer
    ...
    ########################################################################
    file_name = f"{re.sub(r'[ ()]', '', CHOOSE_MODEL) }-atc-qwen-clm-original-model.pth"
    ...
    loss_data_path = f"loss-data-qwen-clm-loss{re.sub(r'[ ()]', '', CHOOSE_MODEL) }.json"
    ...
    test_data_path = f"atc-test-data-with-response-qwen-clm-loss{re.sub(r'[ ()]', '', CHOOSE_MODEL) }.json"
    with open(test_data_path, "w") as file:
        json.dump(test_data, file, indent=4)  # "indent" for pretty-printing
    print(f"Responses saved as {test_data_path}")

    file_name = f"{re.sub(r'[ ()]', '', CHOOSE_MODEL) }-atc-qwen-clm-loss.pth"
    torch.save(model.state_dict(), file_name)
