...
# CONFIGURATION
# ============================================================================
MODEL_BASE_PATH = "gpt2-large774M-atc-gpt2-clm-original-model.pth"  
...
def load_models_and_vocab():
    ...
    model_base = build_base_gpt_model()
...
def main():
    ...
    test_prompts = [instruction_text + prompt for prompt in test_prompts]
    ...
    gens_base = [
        generate_with_tiktoken(model_base, p, tokenizer, MAX_NEW_TOKENS, DEVICE)
